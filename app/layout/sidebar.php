        ...
        <ul class="sidebar-menu">
            ...
            ?>
                ...
                ?>
                    ...
                    <?php if ($nav === 'user' && ($act === 'create'|| $act === 'read' || $act === 'edit' || $act === 'delete')) { ?>
                        <li class="dropdown active ">
                        <?php } else { ?>
                        <li class="dropdown ">
                        <?php } ?>
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="nav-link" href="index.php?page=user&act=read">User</a></li>
                    ...
                    <?php if ($nav === 'user' && ($act === 'confirm-Password' || $act === 'lupa-Password')){ ?>
                        <li class="dropdown active ">
                        <?php } else { ?>
                        <li class="dropdown ">
                        <?php } ?>
                        <a href="#" class="nav-link has-dropdown"><i class="fas fa-key"></i><span>Ganti Password</span></a>
                        <ul class="dropdown-menu">
                            <li><a class="nav-link" href="index.php?page=user&act=confirm-Password&id="<?= $currentUser['id']; ?>>Konfirmasi Password</a></li>
                            <li><a class="nav-link" href="index.php?page=user&act=lupa-Password">Lupa Password</a></li>
                            </ul>
                        </li>
